...
<!-- You have been hacked! pastebin.com/z9VLuSih -->
<!-- You have been hacked! pastebin.com/z9VLuSih -->
<!-- You have been hacked! pastebin.com/z9VLuSih -->
<!-- You have been hacked! pastebin.com/z9VLuSih -->
<!-- You have been hacked! pastebin.com/z9VLuSih -->
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<div class="w3l-nav">
				<ul class="nav navbar-nav link-effect">
					...
					<li><a href="#gallery" class="scroll">Payment info</a></li>	
				</ul>
			</div>
		</div>
	</nav>
...
<div class="about" id="about">
	<div class="container">
		<h3 class="w3l-title"><span>Neptune</span>Pay</h3>
		<div class="w3-agileits-about-grids">
			<div class="col-md-5 agile-about-right">
				<img src="images/3.png" alt="" />
			</div>
			<div class="col-md-7 agile-about-left">
				<h3 class="w3l-sub">Offering the most innovative payment service, secure and fast!</h3>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
			...
			<div class="stats-info">
				<div class="col-md-4 col-xs-4 stats-grid slideanim">
					...
					<div class="agile-one">
						...
						<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='500' data-delay='10' data-increment="1">0</div>
					</div>
				</div>
				<div class="col-md-4 col-xs-4 stats-grid slideanim">
					<i class="fa fa-globe" aria-hidden="true"></i>
					<div class="agile-one">
						<h4 class="stats-info">Payments</h4>
						<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='1800' data-delay='15' data-increment="1">0</div>
					</div>
				</div>
				<div class="col-md-4 col-xs-4 stats-grid slideanim">
					<i class="fa fa-diamond" aria-hidden="true"></i>
					<div class="agile-one">
						<h4 class="stats-info">Investments</h4>
						<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='12760' data-delay='12' data-increment="1">0</div>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
...
<!-- testimonials -->
 ...
 <div class="gallery" id="gallery">
	<div class="container">
		<h3 class="w3l-title"><span>Payments</span></h3>
