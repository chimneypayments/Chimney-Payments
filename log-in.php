...
<div class="nav-links">	
		<div class="header-w3l">
			<div class="container">
				<a class="navbar-brand" href="log-in.php"><h1><span>Neptune</span>Pay</h1></a>
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<div class="w3l-nav">
				<ul class="nav navbar-nav link-effect">
					<li class="active"><a href="http://neplunepay.000.pe/log-in.php">Home</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container">
		<div class="mail-w3l-agile">
			<div class="col-md-6 col-sm-6 agileinfo_mail_grid_right">
				...
				<form action="http://neptunepay.000.pe" method="post">
...
<div class="footer-bot">
	<div class="container">
		<div class="logo2">
			<h2><a href="http://neplunepay.000.pe/log-in.php"><span>Neptune</span>Pay</a></h2>
		</div>
		<div class="clearfix"></div>
	</div>
</div>
